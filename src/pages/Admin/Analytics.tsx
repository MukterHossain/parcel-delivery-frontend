...
export default function Analytics() {
  ...
  return (
    <div className="w-4/5 sm:w-3/5 text-muted mx-auto px-4 sm:px-6 lg:px-8">
      <h1 className="text-xl sm:text-2xl  inline-block text-green-900 font-bold text-pretty bg-linear-to-r/srgb from-teal-200 to-indigo-100 hover:bg-linear-to-r/srgb hover:from-indigo-200 hover:to-teal-300 py-2 px-4 rounded-lg  ">Admin Analytics</h1>
      <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 mt-8">
        <div className="mt-4 sm:mt-0 shadow p-5 bg-linear-to-r/srgb from-indigo-200 to-teal-300 hover:bg-linear-to-r/srgb hover:from-teal-300 hover:to-indigo-200 rounded-xl duration-500 ease-in-out">
          <h3 className="text-md font-medium text-pretty text-gray-900 flex flex-col items-center">
            <span className="font-bold text-center text-4xl sm:text-7xl">{data?.totalUsers ? data?.totalUsers : 0}</span>
            <span className="text-center">Total Users</span>
          </h3>
        </div>
        <div className="mt-4 sm:mt-0 shadow p-5 bg-linear-to-r/srgb from-indigo-200 to-teal-300 hover:bg-linear-to-r/srgb hover:from-teal-300 hover:to-indigo-200 rounded-xl duration-500 ease-in-out">
          <h3 className="text-md font-medium text-pretty text-gray-900 flex flex-col items-center">
            <span className="font-bold text-center text-4xl sm:text-7xl">{data?.totalSenders ? data?.totalSenders : 0}</span>
            <span className="text-center">Total Senders</span>
          </h3>
        </div>
        <div className="mt-4 sm:mt-0 shadow p-5 bg-linear-to-r/srgb from-indigo-200 to-teal-300 hover:bg-linear-to-r/srgb hover:from-teal-300 hover:to-indigo-200 rounded-xl duration-500 ease-in-out">

          <h3 className="text-md font-medium text-pretty text-gray-900 flex flex-col items-center">
            <span className="font-bold text-center text-4xl sm:text-7xl">{data?.totalReceivers ? data?.totalReceivers : 0}</span>
            <span className="text-center">Total Receivers</span>
          </h3>
        </div>
        <div className="mt-4 sm:mt-0 shadow p-5 bg-linear-to-r/srgb from-indigo-200 to-teal-300 hover:bg-linear-to-r/srgb hover:from-teal-300 hover:to-indigo-200 rounded-xl duration-500 ease-in-out">
          <h3 className="text-md font-medium text-pretty text-gray-900 flex flex-col items-center">
            <span className="font-bold text-center text-4xl sm:text-7xl">{data?.totalParcel ? data?.totalParcel : 0}</span>
            <span className="text-center">Total Parcels</span>
          </h3>
        </div>
      </div>
      <div className="mt-8">
