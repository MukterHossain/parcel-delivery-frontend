...
export default function ParcelTracking() {
  ...
  return (
    <div className="max-w-7xl mx-auto p-5 text-muted-foreground">
      <h1 className="text-2xl  inline-block text-green-900 font-bold text-pretty bg-linear-to-r/srgb from-teal-200 to-indigo-100 hover:bg-linear-to-r/srgb hover:from-indigo-200 hover:to-teal-300 py-2 px-4 rounded-lg  ">Parcel Tracking</h1>
      {
        trackginData ? (
          <div className="space-y-5 mt-6">
            <div className="bg-green-100 hover:bg-gray-50 duration-300 shadow-md rounded-lg p-5">
              ...
              <p className="text-gray-700"> <strong>Pickup Address: </strong>{trackginData?.pickupAddress} </p>
              <p className="text-gray-700"> <strong>Pickup Address: </strong>{trackginData?.deliveryAddress} </p>
              <p className="text-gray-700"> <strong>Fee Tk: </strong>{trackginData?.fee ? trackginData?.fee : "00"} </p>

            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="bg-blue-50 hover:bg-green-50 duration-300 shadow-md rounded-lg p-5">
                <h2 className="text-2xl  mb-3"><strong>Sender</strong></h2>

                <p className=""> <span className="font-semibold"><strong>Name: </strong></span>{trackginData?.sender?.name} </p>
              ...
              <div className="bg-green-50 hover:bg-blue-50 shadow-md rounded-lg p-5">
                <h2 className="text-2xl font-semibold mb-3"><strong>Receiver</strong></h2>
            ...
            <div className="bg-gray-50 hover:bg-green-50 shadow-md rounded-lg p-5">
              <h2 className="text-2xl  mb-3"><strong>Status Logs</strong></h2>
              ...
              <ul className="space-y-2">
                {
                  trackginData?.statusLogs?.map((log: { status: string; location?: string; note: string; updatedBy: string; timestamp: string }, index: number) => (
                    <li key={index} className="">
                      ...
                      <p className=""> <strong>Updated At: </strong>{new Date(log?.timestamp).toLocaleString()} </p>
                    </li>
